...
export class ShippingDetailPage {
    ...
    getShippedDetail()
    {
        this.service.post_rqst({'karigar_gift_id' :this.karigar_gift_id},'app_karigar/shippedDetail')
        .subscribe( (r) =>
        {
            console.log(r);
        ...
        recvConfirmation(gift_id)
        {
            let alert=this.alertCtrl.create({
                ...
                },
                {
                    ...
                    handler:()=>
                    {
                        this.service.post_rqst({'karigar_gift_id':this.shipped_detail.karigar_gift_id,'karigar_id':this.service.karigar_id},'app_karigar/redeemReceiveStatus').subscribe(r=>
                            {
                                console.log(r);
